      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead sx={{ bgcolor: "#f5f5f5" }}>
            <TableRow>
              <TableCell align="right">{PERSIAN_LABELS.invoices}</TableCell>
              <TableCell align="right">{PERSIAN_LABELS.users}</TableCell>
              ...
              <TableCell align="right">{PERSIAN_LABELS.paidDate}</TableCell>
